	...
	$(function() {
		$("#inputForm").submit(function() {
			...
			if (flag) {
				...
				$.post("${ctx}/system/sys-role!saveOrUpdate.action", json, function(data) {
					if (data.status) {
...
<body>
	<div class="easyui-layout" data-options="fit:true">
		<div data-options="region:'center',border:false" style="padding: 10px;">
			<form action="${ctx}/system/sys-role!saveOrUpdate.action" id="inputForm" method="post" enctype="multipart/form-data">
				...
				<table>
					...
					<tr>
						<td>角色编码</td>
						<td><input type="text" name="roleCode" class="easyui-textbox" data-options="required:true" value="${model.roleCode }"></input></td>
					</tr>
					<tr>
						<td>状态</td>
